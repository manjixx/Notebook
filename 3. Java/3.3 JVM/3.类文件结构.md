- [一、概述](#一概述)
- [二、 Class 文件结构](#二-class-文件结构)
  - [2.1 概述](#21-概述)
  - [2.2 魔数（Magic Number）](#22-魔数magic-number)
  - [2.3 Class 文件版本号（Minor&Major Version）](#23-class-文件版本号minormajor-version)
  - [2.4 常量池（Constant Pool）](#24-常量池constant-pool)
  - [2.5 访问标志(Access Flags)](#25-访问标志access-flags)
  - [2.6 当前类（This Class）、父类（Super Class）、接口（Interfaces）索引集合](#26-当前类this-class父类super-class接口interfaces索引集合)
  - [2.7 字段表集合（Fields）](#27-字段表集合fields)
  - [2.8 方法表集合（Methods）](#28-方法表集合methods)
  - [2.9 属性表集合（Attributes）](#29-属性表集合attributes)
- [参考](#参考)
...
## 2.3 Class 文件版本号（Minor&Major Version）
...
## 2.6 当前类（This Class）、父类（Super Class）、接口（Interfaces）索引集合
